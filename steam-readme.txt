Personal tweaks for sp Total War mod.
List of changes, see also proposed mod list:

* Supply hub lower build cost from 5000 to 2000
...
* All doctrines research speed +15% (to balance slower research speed - see above).
